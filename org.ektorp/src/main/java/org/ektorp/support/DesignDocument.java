...
public class DesignDocument extends OpenCouchDbDocument {
	...
	private boolean mergeFunctions(Map<String, String> existing,
			Map<String, String> mergeFunctions, boolean updateOnDiff) {
	...
	public static class View {
		...
		public static View of(org.ektorp.support.View v) {
			return v.reduce().length() == 0 ? new DesignDocument.View(v.map())
